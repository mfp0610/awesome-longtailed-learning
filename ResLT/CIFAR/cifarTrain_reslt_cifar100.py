...
def Train():
    ...
    for epoch in range(start_epoch,end_epoch):
        ...
        print("Train epoch=%d loss=%.5f  acc=%.5f\n"%(epoch,train_loss/num,correct/total))
        ...
        print("Test epoch=%d loss=%.5f  acc=%.5f best_acc=%.5f\n"%(epoch,test_loss/num,correct.sum()/total, best_acc))
        #print("Test "+str(correct/class_num)+"\n") 
        #print("Test head acc:"+str(head_acc)+" medium acc "+str(medium_acc)+" tail acc "+str(tail_acc)+"\n")
