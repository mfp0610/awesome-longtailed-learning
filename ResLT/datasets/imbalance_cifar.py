...
class CIFAR10V2(object):
    def __init__(self, batch_size=128, class_balance=False, imb_factor=None):
        ...
        trainset = IMBALANCECIFAR10(root="./data/cifar10", train=True, transform=transform_train, download=False, imb_factor=imb_factor, class_balance=class_balance)
        testset = datasets.CIFAR10(root='./data/cifar10', train=False, transform=transform_test, download=False)
...
class CIFAR100V2(object):
    def __init__(self, batch_size=128, class_balance=False, dual_sampler=False, imb_factor=None):
        ...
        trainset = IMBALANCECIFAR100(root='./data/cifar100', train=True, transform=transform_train, download=False, imb_factor=imb_factor, class_balance=class_balance)
        testset = datasets.CIFAR100(root='./data/cifar100', train=False, transform=transform_test, download=False)
