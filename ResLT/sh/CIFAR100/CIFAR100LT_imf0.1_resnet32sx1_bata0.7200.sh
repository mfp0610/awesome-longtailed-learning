...
python cifarTrain_reslt_cifar100.py -mark CIFAR100V2_imf0.1_res32x1_beta0.7200 --arch ResLTResNet32 --scale 1 --lr 0.1 --weight-decay 5e-4 -dataset CIFAR100V2 --imb_factor 0.1 -num_classes 100 -b 128 --epochs 200 --beta 0.7200
